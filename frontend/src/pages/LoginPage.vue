<template>
  <div class="min-h-screen p-6">
    <div class="mx-auto grid min-h-[calc(100vh-3rem)] max-w-6xl items-center gap-8 lg:grid-cols-[1.2fr_0.8fr]">
      <section class="panel">
        <div class="page-eyebrow !text-slate-500">Ragent Python 管理平台</div>
        ...
        <div class="grid-three mt-8">
          <div class="detail-item">
            <div class="meta-label !text-slate-500">后台管理</div>
            <div class="detail-value">知识库与配置治理</div>
          </div>
          <div class="detail-item">
            <div class="meta-label !text-slate-500">智能对话</div>
            <div class="detail-value">流式会话与追踪回传</div>
          </div>
          <div class="detail-item">
            <div class="meta-label !text-slate-500">链路追踪</div>
            <div class="detail-value">运行与节点双层观测</div>
          </div>
        </div>
      </section>

      <section class="panel">
        <div class="page-eyebrow !text-slate-500">登录</div>
